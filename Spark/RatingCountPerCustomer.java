...
public class RatingCountPerCustomer {
	
	public static void main(String[] args) {
		// String master = "spark://localhost:7077";
		String master = "local";
		// Create a Java Spark Context.
		SparkConf conf = new SparkConf().setAppName("RatingCountPerCustomer").setMaster(
				master);
		;
		...
		// Transform into customers and count.
		...
		counts.saveAsTextFile("hdfs://localhost:9000/user/output/4");
